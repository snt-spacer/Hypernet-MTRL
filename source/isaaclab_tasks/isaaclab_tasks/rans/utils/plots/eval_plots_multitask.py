...
def main():
    list_of_folders = [
        ...
        #Memory
        [
            "/workspace/isaaclab/logs/rsl_rl/multitask_memory_4tasks/2025-06-24_11-15-15_rsl-rl_ppo-memory_GoToPosition-GoToPose-TrackVelocities-GoThroughPoses_FloatingPlatform_r-0_seed-42",
        ],
    ]
    ...
    save_plots_folder_path = "/workspace/isaaclab/source/plots/mtlrl_solved" # Specify the folder path where you want to save the plots
