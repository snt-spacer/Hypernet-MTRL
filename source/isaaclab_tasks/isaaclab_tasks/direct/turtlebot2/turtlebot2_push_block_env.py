...
from isaaclab_tasks.rans import PushBlockCfg, PushBlockTask, TurtleBot2Robot, TurtleBot2RobotCfg


@configclass
class TurtleBot2PushBlockEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 6
...
class TurtleBot2PushBlockEnv(DirectRLEnv):
    # Workflow: Step
