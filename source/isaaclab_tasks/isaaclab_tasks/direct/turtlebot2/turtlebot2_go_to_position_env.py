...
from isaaclab_tasks.rans import GoToPositionCfg, GoToPositionTask, TurtleBot2Robot, TurtleBot2RobotCfg


@configclass
class TurtleBot2GoToPositionEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 6
...
class TurtleBot2GoToPositionEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: TurtleBot2GoToPositionEnvCfg
