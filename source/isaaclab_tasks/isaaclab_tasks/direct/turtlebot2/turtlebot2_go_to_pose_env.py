...
from isaaclab_tasks.rans import GoToPoseCfg, GoToPoseTask, TurtleBot2Robot, TurtleBot2RobotCfg


@configclass
class TurtleBot2GoToPoseEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 6
...
class TurtleBot2GoToPoseEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: TurtleBot2GoToPoseEnvCfg

    def __init__(self, cfg: TurtleBot2GoToPoseEnvCfg, render_mode: str | None = None, **kwargs):
