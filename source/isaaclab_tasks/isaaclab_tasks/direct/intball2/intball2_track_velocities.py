...
from isaaclab_tasks.rans import IntBall2Robot, IntBall2RobotCfg, TrackVelocities3DCfg, TrackVelocities3DTask


@configclass
class IntBall2TrackVelocitiesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class IntBall2TrackVelocitiesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: IntBall2TrackVelocitiesEnvCfg
