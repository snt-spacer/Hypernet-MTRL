...
from isaaclab_tasks.rans import GoToPosition3DCfg, GoToPosition3DTask, IntBall2Robot, IntBall2RobotCfg


@configclass
class IntBall2GoToPositionEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class IntBall2GoToPositionEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: IntBall2GoToPositionEnvCfg
    ...
    def _setup_scene(self):
        ...
        self.task_api = GoToPosition3DTask(
            self.scene,
            self.cfg.task_cfg,
            task_uid=0,
            num_envs=self.num_envs,
