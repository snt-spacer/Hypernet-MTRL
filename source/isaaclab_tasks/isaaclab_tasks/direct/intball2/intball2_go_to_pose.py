...
from isaaclab_tasks.rans import GoToPose3DCfg, GoToPose3DTask, IntBall2Robot, IntBall2RobotCfg


@configclass
class IntBall2GoToPoseEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class IntBall2GoToPoseEnv(DirectRLEnv):
    # Workflow: Step
