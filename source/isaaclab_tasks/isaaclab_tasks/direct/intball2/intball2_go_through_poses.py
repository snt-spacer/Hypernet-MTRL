...
from isaaclab_tasks.rans import GoThroughPoses3DCfg, GoThroughPoses3DTask, IntBall2Robot, IntBall2RobotCfg


@configclass
class IntBall2GoThroughPosesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class IntBall2GoThroughPosesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: IntBall2GoThroughPosesEnvCfg
    ...
    def _setup_scene(self):
        ...
        self.task_api = GoThroughPoses3DTask(
            self.scene,
            self.cfg.task_cfg,
            task_uid=0,
            num_envs=self.num_envs,
