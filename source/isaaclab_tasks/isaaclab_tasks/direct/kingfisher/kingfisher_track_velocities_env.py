...
from isaaclab_tasks.rans import KingfisherRobot, KingfisherRobotCfg, TrackVelocitiesCfg, TrackVelocitiesTask


@configclass
class KingfisherTrackVelocitiesEnvCfg(DirectRLEnvCfg):
    ...
    task_cfg: TrackVelocitiesCfg = TrackVelocitiesCfg(
        goal_min_ang_vel=0,
        goal_max_ang_vel=0.5,
        goal_min_lat_vel=0,
        goal_max_lat_vel=0,
        goal_min_lin_vel=0.0,
        goal_max_lin_vel=1.25,
    )
    debug_vis: bool = True
...
class KingfisherTrackVelocitiesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: KingfisherTrackVelocitiesEnvCfg

    def __init__(self, cfg: KingfisherTrackVelocitiesEnvCfg, render_mode: str | None = None, **kwargs):
