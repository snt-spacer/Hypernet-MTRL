...
from isaaclab_tasks.rans import GoThroughPositionsCfg, GoThroughPositionsTask, KingfisherRobot, KingfisherRobotCfg


@configclass
class KingfisherGoThroughPositionsEnvCfg(DirectRLEnvCfg):
...
class KingfisherGoThroughPositionsEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: KingfisherGoThroughPositionsEnvCfg

    def __init__(self, cfg: KingfisherGoThroughPositionsEnvCfg, render_mode: str | None = None, **kwargs):
