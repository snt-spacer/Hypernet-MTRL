...
from isaaclab_tasks.rans import GoToPoseCfg, GoToPoseTask, KingfisherRobot, KingfisherRobotCfg


@configclass
class KingfisherGoToPoseEnvCfg(DirectRLEnvCfg):
...
class KingfisherGoToPoseEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: KingfisherGoToPoseEnvCfg

    def __init__(self, cfg: KingfisherGoToPoseEnvCfg, render_mode: str | None = None, **kwargs):
