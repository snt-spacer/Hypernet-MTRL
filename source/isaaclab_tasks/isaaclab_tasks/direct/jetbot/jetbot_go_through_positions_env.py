...
from isaaclab_tasks.rans import GoThroughPositionsCfg, GoThroughPositionsTask, JetbotRobot, JetbotRobotCfg


@configclass
class JetbotGoThroughPositionsEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class JetbotGoThroughPositionsEnv(DirectRLEnv):
    ...
    cfg: JetbotGoThroughPositionsEnvCfg
