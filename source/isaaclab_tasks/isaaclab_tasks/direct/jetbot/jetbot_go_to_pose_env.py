...
from isaaclab_tasks.rans import GoToPoseCfg, GoToPoseTask, JetbotRobot, JetbotRobotCfg


@configclass
class JetbotGoToPoseEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class JetbotGoToPoseEnv(DirectRLEnv):
    # Workflow: Step
