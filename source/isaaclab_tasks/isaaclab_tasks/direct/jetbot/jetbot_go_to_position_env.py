...
from isaaclab_tasks.rans import GoToPositionCfg, GoToPositionTask, JetbotRobot, JetbotRobotCfg


@configclass
class JetbotGoToPositionEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class JetbotGoToPositionEnv(DirectRLEnv):
    # Workflow: Step
