...
from isaaclab_tasks.rans import GoThroughPosesCfg, GoThroughPosesTask, JetbotRobot, JetbotRobotCfg


@configclass
class JetbotGoThroughPosesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class JetbotGoThroughPosesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: JetbotGoThroughPosesEnvCfg
