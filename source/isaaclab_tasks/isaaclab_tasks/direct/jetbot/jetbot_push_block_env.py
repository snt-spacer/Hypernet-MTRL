...
from isaaclab_tasks.rans import JetbotRobot, JetbotRobotCfg, PushBlockCfg, PushBlockTask


@configclass
class JetbotPushBlockEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class JetbotPushBlockEnv(DirectRLEnv):
    # Workflow: Step
    ...
    #   - (Check if noise is requirefrom isaaclab.scene import InteractiveScened)
    #       - self._add_noise

    cfg: JetbotPushBlockEnvCfg
