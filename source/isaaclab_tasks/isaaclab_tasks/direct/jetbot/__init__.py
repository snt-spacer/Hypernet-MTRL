...
gym.register(
    ...
    kwargs={
        ...
        "rsl_rl_ppo_beta_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_beta_cfg:JetbotPPORunnerCfg",
...
gym.register(
    ...
    kwargs={
        "env_cfg_entry_point": (
            f"{__name__}.jetbot_go_to_position_with_obstacles_env:JetbotGoToPositionWithObstaclesEnvCfg"
        ),
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JetbotPPORunnerCfg",
        "rsl_rl_ppo_beta_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_beta_cfg:JetbotPPORunnerCfg",
...
gym.register(
    id="Isaac-Jetbot-RaceGates-Direct-v0",
    entry_point=f"{__name__}.jetbot_race_gates_env:RaceGatesEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.jetbot_race_gates_env:JetbotRaceGatesEnvCfg",
        "rl_games_cfg_entry_point": f"{agents.__name__}:rl_games_ppo_cfg.yaml",
        "rsl_rl_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_cfg:JetbotPPORunnerCfg",
        "rsl_rl_ppo_beta_cfg_entry_point": f"{agents.__name__}.rsl_rl_ppo_beta_cfg:JetbotPPORunnerCfg",
        "skrl_cfg_entry_point": f"{agents.__name__}:skrl_ppo_cfg.yaml",
