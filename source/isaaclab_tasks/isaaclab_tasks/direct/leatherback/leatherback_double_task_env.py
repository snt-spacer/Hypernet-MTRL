...
from isaaclab_tasks.rans import GoToPositionCfg, GoToPositionTask, GoToPoseCfg, GoToPoseTask, LeatherbackRobot, LeatherbackRobotCfg


@configclass
class LeatherbackDoubleTaskEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class LeatherbackDoubleTaskEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: LeatherbackDoubleTaskEnvCfg
