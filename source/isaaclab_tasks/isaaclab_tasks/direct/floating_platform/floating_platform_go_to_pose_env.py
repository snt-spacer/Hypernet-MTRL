...
from isaaclab_tasks.rans import FloatingPlatformRobot, FloatingPlatformRobotCfg, GoToPoseCfg, GoToPoseTask


@configclass
class FloatingPlatformGoToPoseEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class FloatingPlatformGoToPoseEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: FloatingPlatformGoToPoseEnvCfg

    def __init__(self, cfg: FloatingPlatformGoToPoseEnvCfg, render_mode: str | None = None, **kwargs):
