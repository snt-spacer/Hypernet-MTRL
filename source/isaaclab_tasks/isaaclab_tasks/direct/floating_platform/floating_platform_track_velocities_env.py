...
from isaaclab_tasks.rans import FloatingPlatformRobot, FloatingPlatformRobotCfg, TrackVelocitiesCfg, TrackVelocitiesTask


@configclass
class FloatingPlatformTrackVelocitiesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class FloatingPlatformTrackVelocitiesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: FloatingPlatformTrackVelocitiesEnvCfg

    def __init__(self, cfg: FloatingPlatformTrackVelocitiesEnvCfg, render_mode: str | None = None, **kwargs):
