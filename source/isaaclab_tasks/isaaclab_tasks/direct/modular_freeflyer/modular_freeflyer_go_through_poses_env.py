...
from isaaclab_tasks.rans import GoThroughPosesCfg, GoThroughPosesTask, ModularFreeflyerRobot, ModularFreeflyerRobotCfg


@configclass
class ModularFreeflyerGoThroughPosesEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class ModularFreeflyerGoThroughPosesEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: ModularFreeflyerGoThroughPosesEnvCfg
