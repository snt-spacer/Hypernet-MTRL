...
from isaaclab_tasks.rans import GoToPositionCfg, GoToPositionTask, ModularFreeflyerRobot, ModularFreeflyerRobotCfg


@configclass
class ModularFreeflyerGoToPositionEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class ModularFreeflyerGoToPositionEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: ModularFreeflyerGoToPositionEnvCfg
