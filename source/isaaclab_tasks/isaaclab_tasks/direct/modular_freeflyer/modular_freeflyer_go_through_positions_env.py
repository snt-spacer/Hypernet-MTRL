...
@configclass
class ModularFreeflyerGoThroughPositionsEnvCfg(DirectRLEnvCfg):
    # env
    decimation = 4
...
class ModularFreeflyerGoThroughPositionsEnv(DirectRLEnv):
    # Workflow: Step
    ...
    cfg: ModularFreeflyerGoThroughPositionsEnvCfg
